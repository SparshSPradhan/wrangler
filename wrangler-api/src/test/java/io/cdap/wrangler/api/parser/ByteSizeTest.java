...
public class ByteSizeTest {
  ...
  public void testValidByteSizes() {
    ...
    Assert.assertEquals(1536 * 1024, new ByteSize("1.5MB").getBytes());
    
    // Test with spaces
    Assert.assertEquals(2048, new ByteSize("2 KB").getBytes());
  }
  ...
  public void testGetters() {
    ...
    Assert.assertEquals(10.5, size.getValue(), 0.001);
