 ...
 */
 ...
 public enum TokenType implements Serializable {
    ...
    * This type is associated with byte size values in the format "<number><unit>" 
    * where unit is one of B, KB, MB, GB, TB, PB. E.g. "10KB", "1.5MB"
    */
   BYTE_SIZE,
 
   /**
    * Represents the enumerated type for the object of type {@code TimeDuration} type.
    * This type is associated with time duration values in the format "<number><unit>"
    * where unit is one of ms, s, m, h, d. E.g. "100ms", "1.5s"
    */
   TIME_DURATION,
